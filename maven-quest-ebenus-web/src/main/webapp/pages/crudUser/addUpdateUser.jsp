             ...
             <section>
                    <div class="content">
                        <div class="User quest">
                            ...
                            <form  method="post" action="CrudUserServlet?action=update&id=<%= u.getIdUtilisateur() %>" id="customer-info-form" class="no-gutters">
                                    ...
                                    <fieldset class=" common-form-controls col-md-3">
                                        <div >
                                            ...
                                            <div class="input-wrapper">
                                                ...
                                                <input  autocomplete="on"  name="firstname" id="firstname" type="text" value="<%= u.getPrenom() %>">
                                            </div>
                                            <div class="input-wrapper">
                                                <label for="lastname">Nom<em>*</em></label>
                                                <input  autocomplete="on"  name="lastname" id="lastname" type="text" value="<%= u.getNom() %>">
                                            </div>
                                            <div class="input-wrapper">
                                                <label for="email">Identifiant<em>*</em></label>
                                                <input  autocomplete="off" name="email" id="email" type="email" value="<%= u.getIdentifiant() %>">
                                            </div>
                                        ...
                                        <div class="sel-container">
                                                <div class="sel">
													<select  class="required" name="role" id="select_city"> 
                                                        ...
                                                        <option value="1" <% if(u.getRole().getIdentifiant().equals("Administrateur")) { %> selected <% } %> >Administrateur </option>
                                                        <option value="2" <% if(u.getRole().getIdentifiant().equals("Directeur")) { %> selected <% } %> >Directeur </option>
                                                        <option value="3" <% if(u.getRole().getIdentifiant().equals("Standard")) { %> selected <% } %> >Standard </option>
                                                        <option value="4" <% if(u.getRole().getIdentifiant().equals("Vendeur")) { %> selected <% } %> >Vendeur </option>
                                                        <option value="5" <% if(u.getRole().getIdentifiant().equals("Acheteur")) { %> selected <% } %> >Acheteur </option> 
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="input-wrapper">
                                                ...
                                                <div class="gender">
                                                	<% if(u.getCivilite().equalsIgnoreCase("Mr")){ %>
                                                	<input  autocomplete="off" type="radio" id="male" name="sex" checked="checked" value="Mr"/>
                                                    <label for="male">
                                                    ...
                                                    <input  autocomplete="off" type="radio" id="female" name="sex" checked="checked" value="Mme"/>
                                                    <label for="female">
                                                        <i class="fa fa-female" aria-hidden="true"></i>
                                                    </label>
                                           ...
                                           <% DateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
       										   String strDate = dateFormat.format(u.getDateNaissance());
                                            %>
                                            <div class="input-wrapper">
                                                <label style="display: block;"> Date de naissance<em>*</em></label>
                                                <input  autocomplete="off" id="dteNaiss" name="dteNaiss" style="width:auto;" data-toggle="datepicker" type="text" value="<%= strDate %>" name="naissance">
                                            </div>
                                    </fieldset>
                                </div>
                                <div class="row">
             ...
             <section>
                    <div class="content">
                        <div class="User quest">
                            ...
                            <form  method="post" action="CrudUserServlet?action=add" id="customer-info-form" class="no-gutters">
                                <div class="account-container row">
                                    <fieldset class=" common-form-controls col-md-3">
                                        <div >
                                            <p>Informations Personnelles</p>
                                    ...
                                    <fieldset class="col-md-3">
                                        ...
                                        <div class="sel-container">
                                                ...
                                                <option value="4">Vendeur </option>
                                                <option value="5">Acheteur </option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="input-wrapper">
