...
public class JUnitQuestEbenus {
	...
	public void testCreateUpdateDeleteUtilisateur() {
		log.debug("Entree de la methode utilisateur");
		...
		Utilisateur userCRUD = new Utilisateur(null, "Mme", "Nicole", "Valentine", "nicole.valentine@gmail.com", "passw0rd",
				date, date, date, true, true, 0, roleCRUD);
