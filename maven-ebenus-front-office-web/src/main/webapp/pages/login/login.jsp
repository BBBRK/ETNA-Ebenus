            ...
            <div class="header-outer" id="header-outer">
                ...
                <header id="header"  class="header">
                    <div class="header padd-top">
                        <a href="${pageContext.request.contextPath}" title="Ebenus" class="logo">Ebenus projet libre</a>
                    </div>
                </header>
            </div>
            <!-- Section -->
                            ...
                            <div class="row">
                                <div class="col-md-5 registered-users">
                                    <div>
                                        ...
                                        <p>Connectez-vous avec votre <strong>adresse e-mail</strong> et votre <strong>mot de passe</strong> pour accéder à votre espace.</p>
                                        <p>Si vous n'avez pas de compte, veuillez vous en creer un <a href="UserServlet?action=subscribe"><strong class="subscribe">ici</strong></a></p>
                                        <ul class="form-list">
                                            <li>
